(function () {
  ...
  var getPathToString_1 = getPathToString;
  ...
  function getIterate(_) {
    var pathToString = getPathToString_1(_);
  ...
  var getEachDeep_1 = getEachDeep;

  function getCondenseDeep(_) {
    var eachDeep = getEachDeep_1(_);
    var condense = getCondense_1(_);
    var _each = _.each || _.forArray;
  ...
  var getCondenseDeep_1 = getCondenseDeep;
  ...
  var getObtain_1 = getObtain;

  function getFilterDeep(_) {
    // console.log('getFilterDeep:', _);
    var eachDeep = getEachDeep_1(_);
    var pathToString = getPathToString_1(_);
    var obtain = getObtain_1(_);
    var condenseDeep = getCondenseDeep_1(_);
    var exists = getExists_1(_);
  ...
  var getFilterDeep_1 = getFilterDeep;

  var deps = {};

  var condenseDeps = deps;

  var chunk38e2ecce = {
  	condenseDeps: condenseDeps
  };
  ...
  var _isString = _interopDefault(isString_1);
  var _reduce = _interopDefault(reduce_1);
  ...
  var _merge = _interopDefault$1(merge_1);


  var _identity = _interopDefault$1(identity_1);
  var _isString$1 = _interopDefault$1(isString_1);
  var _toPath = _interopDefault$1(toPath_1);
  var _isObject = _interopDefault$1(isObject_1);
  var _isEmpty = _interopDefault$1(isEmpty_1);
  var _findIndex = _interopDefault$1(findIndex_1);
  var _forOwn = _interopDefault$1(forOwn_1);
  var _get = _interopDefault$1(get_1);
  var _some = _interopDefault$1(some_1);
  ...
  var eachDeepDeps = deps$2$1;

  var chunkB49b6706 = {
  	eachDeepDeps: eachDeepDeps
  };
  ...
  var _merge$1 = _interopDefault$2(merge_1);
  ...
  var deps$3 = _merge$1(
    ...
    chunk38e2ecce.condenseDeps,
    chunkB49b6706.eachDeepDeps
  );

  var condenseDeepDeps = deps$3;

  var chunk5e815ba3 = {
  	condenseDeepDeps: condenseDeepDeps
  };
  ...
  var _toPath$1 = _interopDefault$3(toPath_1);
  var _get$1 = _interopDefault$3(get_1);
  var _clone = _interopDefault$3(clone_1);
  ...
  var existsDeps = deps$4;

  var chunkD297bbe4 = {
  	existsDeps: existsDeps
  };
  ...
  function iteratee(func) {
    return _baseIteratee(typeof func == 'function' ? func : _baseClone(func, CLONE_DEEP_FLAG$2));
  }
  ...
  var _get$2 = _interopDefault$4(get_1);

  var deps$5 = { get: _get$2 };
  ...
  var _merge$2 = _interopDefault$5(merge_1);

  var _isObject$1 = _interopDefault$5(isObject_1);



  var _clone$1 = _interopDefault$5(clone_1);

  var _cloneDeep = _interopDefault$5(cloneDeep_1);
  var _each = _interopDefault$5(each);
  var _eachRight = _interopDefault$5(eachRight);
  var _has = _interopDefault$5(has_1);
  var _set = _interopDefault$5(set_1);
  var _unset = _interopDefault$5(unset_1);
  var _isPlainObject = _interopDefault$5(isPlainObject_1);
  var _iteratee = _interopDefault$5(iteratee_1);
  ...
  var deps$6 = _merge$2(
    ...
    chunk6b1697aa.deps,
    chunk4b9ace32.deps,
    chunk5e815ba3.condenseDeepDeps,
    chunkD297bbe4.existsDeps
  );

  var filterDeepDeps = deps$6;

  var chunk03173d1d = {
  	filterDeepDeps: filterDeepDeps
  };

  var filterDeep = getFilterDeep_1(chunk03173d1d.filterDeepDeps);

  var filterDeep_1 = filterDeep;

  var obj = { a: true, b: false };
  each(obj, (v) => console.log(v));
  console.log(filterDeep_1(obj));
